            ...
            <div className='flex w-full sm:w-1/2 items-center justify-center my-5'>
                <div className='text-[#414141] flex flex-col gap-1.5 sm:gap-0'>
                    <div className='flex items-center gap-2'>
                        <FaPaw size={20} />
                        <p className='font-medium text-lg sm:text-base'>All Your</p>
                    </div>
                    <h1 className='text-3xl sm:py-3 lg:text-5xl'>Pet Essentials</h1>
                    <div className='flex items-center gap-2'>
                        <p className='font-medium text-lg sm:text-base'>In One Place</p>
                        <FaPaw size={20} />
                    </div>
                </div>
            </div>
